...
Pushing to the default branch (`devin/example-website`) triggers
`.github/workflows/static.yml`, which publishes the repo to GitHub Pages.
Enable Pages once under **Settings → Pages → Build and deployment →
Source: GitHub Actions**. Live at
<https://freecodeforeveryone.github.io/testbuddy/>.
