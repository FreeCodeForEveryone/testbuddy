...
An interactive, single-page comparison of **Devin** and other AI coding agents
— built with plain HTML, CSS, and JavaScript (no build step, no dependencies)
and deployed to **GitHub Pages**.

## What's inside

Compares nine coding agents — **Devin, OpenAI Codex, Claude Code, Cursor, GitHub
Copilot, Windsurf, Replit Agent, Google Jules, and Amazon Kiro** — across nine
capabilities.
...
Ratings are a research-backed but opinionated snapshot (mid-2026). Each tool in
